...
try{
	...
	$lead = $api_connector->create(array(
		'name'			=> $_POST['name'],
		'phone'			=> $_POST['phone'],
		'offer_id'		=> '1480',                         // offer_id из ЛК
		'stream_id'		=> '23726',                         // Optional, stream_id 
		'country' 		=> 'ES',                            // Country in format https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
		'tz' 			=> '',
		'address' 		=> '',
...
{
    public $config = array(
        'api_key' => '7f7b0e62d14f3ff667a8506507878d24',                                     		// api_key of user
        'user_id' =>  '5113',                                                              		// user_id
